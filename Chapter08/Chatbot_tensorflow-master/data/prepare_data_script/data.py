...
'''
def get_id2line():
    lines=open('/home/jalaj/PycharmProjects/Chatbot_using_tensorflow/raw_data/movie_lines.txt', encoding='utf-8', errors='ignore').read().split('\n')
    id2line = {}
    for line in lines:
        _line = line.split(' +++$+++ ')
        if len(_line) == 5:
...
def get_conversations():
    conv_lines = open('/home/jalaj/PycharmProjects/Chatbot_using_tensorflow/raw_data/movie_conversations.txt', encoding='utf-8', errors='ignore').read().split('\n')
    convs = [ ]
